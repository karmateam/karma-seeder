...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Karma-seeder\n"
...
static const string mainnet_seeds[] = {"karmaseeder.alltheco.in", ""};
static const string testnet_seeds[] = {"testnet-karmaseeder.alltheco.in", ""};
